...
// Resume Tailoring
router.post("/resume-tailor/generate",auth,aiLimiter,aiController.generateResume);
...
// Cover Letter
router.post("/cover-letter/generate", auth, aiLimiter, aiController.generateCoverLetter);
...
// Interview Questions
router.post("/interview/generate", auth, aiLimiter, aiController.generateInterview);
